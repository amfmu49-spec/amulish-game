...
/g)||[]).length;if(n>bn&&t.length>80&&t.length<4000){bn=n;L=t;}});}var tt=(document.title||'').replace(/[|–-].*/,'').trim()||'SUNO';var u='https://amfmu49-spec.github.io/amulish-game/?audio='+encodeURIComponent(s)+'&title='+encodeURIComponent(tt);if(L)u+='&lyrics='+encodeURIComponent(L.substring(0,3000));window.open(u,'_blank');})();`;function z(){let e=document.createElement(`div`);if(e.id=`ui-overlay`,e.innerHTML=`
    <style>
      #ui-overlay {
