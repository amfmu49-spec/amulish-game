...
var url='https://amfmu49-spec.github.io/amulish-game/?audio='+encodeURIComponent(src)+'&title='+encodeURIComponent(title);
if(lyricsText){
...
})();`.replace(/\n/g,``);function B(){let e=document.createElement(`div`);if(e.id=`ui-overlay`,e.innerHTML=`
    <style>
      #ui-overlay {
